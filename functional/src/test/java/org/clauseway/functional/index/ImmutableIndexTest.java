...
// ABOUTME: Pins the persistent path-trie: path put/get/remove round-trips,
// ABOUTME: sibling isolation, empty-path identity, and structural merge.
...
public class ImmutableIndexTest {
	...
	public void shouldPutAndGetBasic() {
		ImmutableIndex<Integer, Integer> index = ImmutableIndex.<Integer, Integer> of(0)
				.withIndexAt(Array.of(1), () -> 0, i -> i.withValue(123));
