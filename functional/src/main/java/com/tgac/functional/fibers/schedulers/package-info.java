...
/**
 * Termination detection as a value: a {@link com.tgac.functional.fibers.schedulers.Fixpoint}
 * pairs a monotonically growing {@link com.tgac.functional.fibers.schedulers.MonotoneCell}
 * (whose growth wakes parked subscribers) with a
 * {@link com.tgac.functional.fibers.schedulers.WorkLedger} (running work counted
 ...
 * (stratification), never quiescence-completed. A Fixpoint's seal must not be
