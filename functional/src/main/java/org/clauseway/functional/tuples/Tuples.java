...
// ABOUTME: arity dispatched 1-8 — the untyped door mirrors withMembers.
...
public final class Tuples {
	...
	/** A tuple of the members' arity; refuses arity 0 and anything above 8. */
		...
		switch (members.length) {
			...
			default:
				throw new IllegalArgumentException(
						"no tuple of arity " + members.length + ": " + Arrays.toString(members));
		}
	}
}
